...
#undef LHK
      ...
      struct RaiseProps : public kaleidoscope::device::BaseProps
      {
  ...
  // typedef kaleidoscope::device::keyboardio::Raise Device;
  EXPORT_DEVICE(kaleidoscope::device::keyboardio::Raise)
