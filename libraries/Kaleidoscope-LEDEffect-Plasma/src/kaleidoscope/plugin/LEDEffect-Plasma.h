...
class LEDPlasmaWaveEffect : public LEDMode {
 ...
 private:
  ...
  uint8_t LED_COUNT = Runtime.device().led_count;
...
extern kaleidoscope::plugin::LEDPlasmaEffect LEDPlasmaEffect;
extern kaleidoscope::plugin::LEDPlasmaWaveEffect LEDPlasmaWaveEffect;
